...
/*     valoresDht11Umidade,
    ...
    valoresLm35Temperatura2,
    valoresLm35Temperatura3,
    valoresLm35Temperatura4
...
/*     valoresChave */
        ...
        poolBancoDados = mysql.createPool(
            {
                ...
                // parametrizar igual o banco do gabriel
            }
        ).promise();
        // poolBancoDados = mysql.createPool(
        //     {
   ...
   /*      const dht11Umidade = parseFloat(valores[0]);
        ...
        const lm35Temperatura2 = parseFloat(valores[1]);
        const lm35Temperatura3 = parseFloat(valores[2]);
        const lm35Temperatura4 = parseFloat(valores[3]);
...
/*         valoresDht11Umidade.push(dht11Umidade);
  ...
  /*       valoresLuminosidade.push(luminosidade); */
        ...
        valoresLm35Temperatura3.push(lm35Temperatura3);
        valoresLm35Temperatura4.push(lm35Temperatura4);
...
/*     const valoresDht11Umidade = [];
    ...
    const valoresLm35Temperatura2 = [];
    const valoresLm35Temperatura3 = [];
    const valoresLm35Temperatura4 = [];
/*     const valoresChave = []; */
    await serial(
/*         valoresDht11Umidade,
        valoresDht11Temperatura, */
